...
public class JIFSign_In extends JFrame implements ActionListener, KeyListener {
	...
	public JIFSign_In() {
		...
		btnIngresar.setBounds(36, 352, 130, 33);
		...
		btnRegistrar.setIcon(new ImageIcon(JIFSign_In.class.getResource("/imagen/plus.png")));
		btnRegistrar.setBounds(176, 352, 137, 33);
